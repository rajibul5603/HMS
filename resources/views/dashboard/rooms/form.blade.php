    ...
    <div class="row">
        ...
        <div class="col-md-5 card" style="max-width: 1000px; margin: auto; padding: 10px 20px;">
            ...
            <div class="row">
                ...
                @if (Route::currentRouteName()=='room.edit')
                <div class="col-md-6">
                    <x-form.input.date id="booking" label="Booking Date" class="form-control form-control-sm" placeholder="Per Day Bad Price" value="{{(isset($room->booking)!='')?$room->booking :''}}" />
                </div>

                <div class="col-md-6">
                    <x-form.input.date id="reliesed" label="Reliesed Date" class="form-control form-control-sm" placeholder="Per Day Bad Price" value="{{(isset($room->reliesed)!='')?$room->reliesed :''}}" />
                </div>
                @endif
